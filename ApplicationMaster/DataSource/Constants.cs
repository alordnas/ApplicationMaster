...
namespace Casamia.Model
{
    public static class Constants
    {
        ...
        public static readonly string Path_No_Found_Error = "路径：{0} 未找到";
        public static readonly string Path_No_Exist_Error = "路径：{0} 不存在";
        public static readonly string Path_Already_Exist_Error = "路径：{0} 已存在";
